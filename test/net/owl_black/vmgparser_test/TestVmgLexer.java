package net.owl_black.vmgparser_test;
...
import net.owl_black.vmgparser.VmgLexer;
import net.owl_black.vmgparser.VmgScanner;
import net.owl_black.vmgparser.VmgToken;
import net.owl_black.vmgparser.VmgTokenType;
